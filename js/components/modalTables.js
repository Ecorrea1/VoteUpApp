class ModalTables extends HTMLElement {
  constructor() {
    super();
              ...
              <div class="modal-body">
                ...
                <form class="row g-2 container" id="createRegister">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="number" class="form-control text-uppercase" id="total" name="total" placeholder="Ingrese cantidad de votos" required>
...
customElements.define('modal-tables-component', ModalTables);